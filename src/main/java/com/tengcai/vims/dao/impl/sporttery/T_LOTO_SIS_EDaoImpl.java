...
public class T_LOTO_SIS_EDaoImpl extends BaseDaoImpl<T_LOTO_SIS_E> implements T_LOTO_SIS_EDao  {
    ...
    public List<T_LOTO_SIS_E> selectT_LOTO_SIS_EList(T_LOTO_SIS_E t_loto_sis_e) throws Exception{
        return getSqlSession().selectList("com.tengcai.vims.entity.sporttery.T_LOTO_SIS_E.selectT_LOTO_SIS_EList",t_loto_sis_e);
    }
    ...
    public int selectT_LOTO_SIS_ECount(T_LOTO_SIS_E t_loto_sis_e) throws Exception{
        return getSqlSession().selectOne("com.tengcai.vims.entity.sporttery.T_LOTO_SIS_E.selectT_LOTO_SIS_ECount",t_loto_sis_e);
    }
    ...
    public int insertT_LOTO_SIS_E(T_LOTO_SIS_E t_loto_sis_e) throws Exception{
        return getSqlSession().insert("com.tengcai.vims.entity.sporttery.T_LOTO_SIS_E.save",t_loto_sis_e);
    }
    /**
     * 批量添加
     */
    public int insertT_LOTO_SIS_E(List<T_LOTO_SIS_E> list) throws Exception{
        return getSqlSession().insert("com.tengcai.vims.entity.sporttery.T_LOTO_SIS_E.saveList",list);
    }
    /**
     * 修改
     */
    public int updateT_LOTO_SIS_E(T_LOTO_SIS_E t_loto_sis_e) throws Exception{
        return getSqlSession().update("com.tengcai.vims.entity.sporttery.T_LOTO_SIS_E.update",t_loto_sis_e);
    }
    /**
     * 批量修改
     */
    public int updateT_LOTO_SIS_E(List<T_LOTO_SIS_E> list) throws Exception{
        return getSqlSession().update("com.tengcai.vims.entity.sporttery.T_LOTO_SIS_E.updateList",list);
    }
    /**
     * 删除
     */
    public int deleteT_LOTO_SIS_E(T_LOTO_SIS_E t_loto_sis_e) throws Exception{
        return getSqlSession().delete("com.tengcai.vims.entity.sporttery.T_LOTO_SIS_E.delete",t_loto_sis_e);
    }
    /**
     * 按统计保存
     */
