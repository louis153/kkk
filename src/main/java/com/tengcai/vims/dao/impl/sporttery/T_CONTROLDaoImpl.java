...
public class T_CONTROLDaoImpl extends BaseDaoImpl<T_CONTROL> implements T_CONTROLDao  {
    ...
    public List<T_CONTROL> selectT_CONTROLList(T_CONTROL t_control) throws Exception{
        return getSqlSession().selectList("com.tengcai.vims.entity.sporttery.T_CONTROL.selectT_CONTROLList",t_control);
    }
    ...
    public int selectT_CONTROLCount(T_CONTROL t_control) throws Exception{
        return getSqlSession().selectOne("com.tengcai.vims.entity.sporttery.T_CONTROL.selectT_CONTROLCount",t_control);
    }
    ...
    public int insertT_CONTROL(T_CONTROL t_control) throws Exception{
        return getSqlSession().insert("com.tengcai.vims.entity.sporttery.T_CONTROL.save",t_control);
    }
    /**
     * 批量添加
     */
    public int insertT_CONTROL(List<T_CONTROL> list) throws Exception{
        return getSqlSession().insert("com.tengcai.vims.entity.sporttery.T_CONTROL.saveList",list);
    }
    /**
     * 修改
     */
    public int updateT_CONTROL(T_CONTROL t_control) throws Exception{
        return getSqlSession().update("com.tengcai.vims.entity.sporttery.T_CONTROL.update",t_control);
    }
    /**
     * 批量修改
     */
    public int updateT_CONTROL(List<T_CONTROL> list) throws Exception{
        return getSqlSession().update("com.tengcai.vims.entity.sporttery.T_CONTROL.updateList",list);
    }
    /**
     * 删除
     */
    public int deleteT_CONTROL(T_CONTROL t_control) throws Exception{
        return getSqlSession().delete("com.tengcai.vims.entity.sporttery.T_CONTROL.delete",t_control);
    }
