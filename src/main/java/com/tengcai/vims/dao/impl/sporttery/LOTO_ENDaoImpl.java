...
public class LOTO_ENDaoImpl extends BaseDaoImpl<T_LOTO_E> implements LOTO_ENDao  {
    ...
    public List<T_LOTO_E> selectLOTO_ENList(T_LOTO_E loto_en) throws Exception{
        return getSqlSession().selectList("com.tengcai.vims.entity.sporttery.T_LOTO_EN.selectT_LOTO_ENList",loto_en);
    }
    ...
    public int selectLOTO_ENCount(T_LOTO_E loto_en) throws Exception{
        return getSqlSession().selectOne("com.tengcai.vims.entity.sporttery.T_LOTO_EN.selectT_LOTO_ENCount",loto_en);
    }
    ...
    public int insertLOTO_EN(T_LOTO_E loto_en) throws Exception{
        return getSqlSession().insert("com.tengcai.vims.entity.sporttery.T_LOTO_EN.save",loto_en);
    }
    /**
     * 批量添加
     */
    ...
    public int updateLOTO_EN(T_LOTO_E loto_bn) throws Exception{
        return getSqlSession().update("com.tengcai.vims.entity.sporttery.T_LOTO_EN.update",loto_bn);
    }
    /**
     * 批量修改
     */
    ...
    public int deleteLOTO_EN(T_LOTO_E loto_en) throws Exception{
        return getSqlSession().delete("com.tengcai.vims.entity.sporttery.T_LOTO_EN.delete",loto_en);
    }

	@Override
	public int deleteAll() throws Exception {
		return getSqlSession().delete("com.tengcai.vims.entity.sporttery.T_LOTO_EN.deleteAll");
	}
	@Override
