...
public class V_ORDERDaoImpl extends BaseDaoImpl<V_ORDER> implements V_ORDERDao  {
    ...
    public List<V_ORDER> selectV_ORDERList(V_ORDER v_order) throws Exception{
        return getSqlSession().selectList("com.tengcai.vims.entity.sporttery.V_ORDER.selectV_ORDERList",v_order);
    }
    ...
    public int selectV_ORDERCount(V_ORDER v_order) throws Exception{
        return getSqlSession().selectOne("com.tengcai.vims.entity.sporttery.V_ORDER.selectV_ORDERCount",v_order);
    }
    ...
    public int insertV_ORDER(V_ORDER v_order) throws Exception{
        return getSqlSession().insert("com.tengcai.vims.entity.sporttery.V_ORDER.save",v_order);
    }
    /**
     * 批量添加
     */
    public int insertV_ORDER(List<V_ORDER> list) throws Exception{
        return getSqlSession().insert("com.tengcai.vims.entity.sporttery.V_ORDER.saveList",list);
    }
    /**
     * 修改
     */
    public int updateV_ORDER(V_ORDER v_order) throws Exception{
        return getSqlSession().update("com.tengcai.vims.entity.sporttery.V_ORDER.update",v_order);
    }
    /**
     * 批量修改
     */
    public int updateV_ORDER(List<V_ORDER> list) throws Exception{
        return getSqlSession().update("com.tengcai.vims.entity.sporttery.V_ORDER.updateList",list);
    }
    /**
     * 删除
     */
    public int deleteV_ORDER(V_ORDER v_order) throws Exception{
        return getSqlSession().delete("com.tengcai.vims.entity.sporttery.V_ORDER.delete",v_order);
    }
