...
public class T_LOTO_ENDaoImpl extends BaseDaoImpl<T_LOTO_E> implements T_LOTO_ENDao  {
    ...
    public List<T_LOTO_E> selectT_LOTO_ENList(T_LOTO_E t_loto_en) throws Exception{
        return getSqlSession().selectList("com.longti.upjc.entity.sporttery.T_LOTO_EN.selectT_LOTO_ENList",t_loto_en);
    }
    ...
    public int selectT_LOTO_ENCount(T_LOTO_E t_loto_en) throws Exception{
        return getSqlSession().selectOne("com.longti.upjc.entity.sporttery.T_LOTO_EN.selectT_LOTO_ENCount",t_loto_en);
    }
    ...
    public int insertT_LOTO_EN(T_LOTO_E t_loto_en) throws Exception{
        return getSqlSession().insert("com.longti.upjc.entity.sporttery.T_LOTO_EN.save",t_loto_en);
    }
    /**
     * 批量添加
     */
    ...
    public int updateT_LOTO_EN(T_LOTO_E t_loto_en) throws Exception{
        return getSqlSession().update("com.longti.upjc.entity.sporttery.T_LOTO_EN.update",t_loto_en);
    }
    /**
     * 批量修改
     */
    ...
    public int deleteT_LOTO_EN(T_LOTO_E t_loto_en) throws Exception{
        return getSqlSession().delete("com.longti.upjc.entity.sporttery.T_LOTO_EN.delete",t_loto_en);
    }
    @Override
