 ...
 * 进行中GTO竞猜话题信息entity
 */
public class T_LOTO_EN_GTO implements Serializable {
	...
	private String compensate_min;//赔付额上限 最小值  存储为设置的真正值
	private String compensate_max;//赔付额上限 最大值   存储为设置的真正值
	private String single_lottery_max;//用户单次投注的上限  存储为设置的真正值
	private String single_match_max;//用户单玩法投注上限
	private Integer sort;//排序
	private Integer lottery_type;//投注类型, 0普通, 1不中返还
	private String return_min;//不中返还额度区间的最小值  存储为设置的真正值
	private String return_max;//不中返还额度区间的最大值   存储为设置的真正值
